...
namespace Eco.Mods.TechTree
{
    ...
    [Tag("Usable")]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "SaplingGreenhouse Item")]
    public partial class SaplingGreenhouseObject : WorldObject, IRepresentsItem, IHasInteractions
    {
        [Serialized] public bool OpenDoors { get; set; }
        public virtual Type RepresentedItemType => typeof(SaplingGreenhouseItem);
        public override LocString DisplayName => Localizer.DoStr("Sapling Greenhouse");
        public override TableTextureMode TableTexture => TableTextureMode.Brick;
		static SaplingGreenhouseObject() 
		{
...
//////////////////////////////////////5x5x13Back//////////////////////////////////////
            ...
            AddOccupancy<SaplingGreenhouseObject>(BlockOccupancyList);
		} 
    ...
    [Serialized]
    [LocDisplayName("Sapling Greenhouse")]
    [LocDescription("Greenhouse for farming wood from saplings.")]
    [IconGroup("World Object Minimap")]
    [Ecopedia("Work Stations", "Craft Tables", createAsSubPage: true)]
    [Tag("Crafting Table")]
    [Weight(5000)] // Defines how heavy SaplingGreenhouse is.
	[MaxStackSize(200)]
    [AllowPluginModules(Tags = new[] { "AdvancedUpgrade" }, ItemTypes = new[] { typeof(LoggingBasicUpgradeItem) })] //noloc
    public partial class SaplingGreenhouseItem : WorldObjectItem<SaplingGreenhouseObject>, IPersistentData
    {
    ...
    /// <summary>
    /// <para>Server side recipe definition for "SaplingGreenhouse".</para>
    /// <para>More information about RecipeFamily objects can be found at https://docs.play.eco/api/server/eco.gameplay/Eco.Gameplay.Items.RecipeFamily.html</para>
    /// </summary>
    [RequiresSkill(typeof(CarpentrySkill), 6)]
    [Ecopedia("Work Stations", "Craft Tables", subPageName: "SaplingGreenhouse Item")]
    public partial class SaplingGreenhouseRecipe : RecipeFamily
    {
        public SaplingGreenhouseRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SaplingGreenhouse",  //noloc
                displayName: Localizer.DoStr("Sapling Greenhouse"),
                ...
                {
                    new CraftingElement<SaplingGreenhouseItem>()
                });
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(SaplingGreenhouseRecipe), start: 10, skillType: typeof(CarpentrySkill), typeof(CarpentryFocusedSpeedTalent), typeof(CarpentryParallelSpeedTalent));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Sapling Greenhouse"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Sapling Greenhouse"), recipeType: typeof(SaplingGreenhouseRecipe));
            this.ModsPostInitialize();
